...
class Ticket(models.Model):
    recipient_id = models.CharField(
        max_length=100, verbose_name="Recipient ID",
    ...
    ss_period = models.PositiveIntegerField(
        null=True, blank=True, verbose_name="Special Serenade Period",
    ...
    p1 = models.CharField(
        null=True, blank=True, max_length=4, editable=False, verbose_name="Period 1 Classroom",
        help_text="Will be automatically determined so do not touch.")
    p2 = models.CharField(
        null=True, blank=True, max_length=4, editable=False, verbose_name="Period 2 Classroom",
        help_text="Will be automatically determined so do not touch.")
    p3 = models.CharField(
        null=True, blank=True, max_length=4, editable=False, verbose_name="Period 3 Classroom",
        help_text="Will be automatically determined so do not touch.")
    p4 = models.CharField(
        null=True, blank=True, max_length=4, editable=False, verbose_name="Period 4 Classroom",
        help_text="Will be automatically determined so do not touch.")
