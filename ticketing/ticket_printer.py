...
class TicketsToPDF:
    def __init__(self, tickets, pdf_output_path: str, pdf_name: str, padding: int = 0):
        ...
        self.ITEM_IMAGES = {
            "Chocolate": self.scale_image(Image(f'{DirectoryLocations.STATIC}/item_types/chocolate.png'),
                                          self.ITEM_TYPE_IMAGE_SIZE, self.ITEM_TYPE_IMAGE_SIZE),
            "Rose": self.scale_image(Image(f'{DirectoryLocations.STATIC}/item_types/rose.png'),
                                     self.ITEM_TYPE_IMAGE_SIZE, self.ITEM_TYPE_IMAGE_SIZE),
            "Serenade": self.scale_image(Image(f'{DirectoryLocations.STATIC}/item_types/serenade.png'),
                                         self.ITEM_TYPE_IMAGE_SIZE, self.ITEM_TYPE_IMAGE_SIZE),
            "Special Serenade": self.scale_image(Image(f'{DirectoryLocations.STATIC}/item_types/special_serenade.png'),
                                                 self.ITEM_TYPE_IMAGE_SIZE, self.ITEM_TYPE_IMAGE_SIZE)
        }
